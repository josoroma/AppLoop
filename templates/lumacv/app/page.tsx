      ...
      <div className="cv-content-grid" data-builder-id="cv-content-grid">
        ...
        <div className="cv-main-column" data-builder-id="cv-main-column">
          ...
          <section className="cv-section cv-experience-section" data-builder-component="ExperienceSection" data-builder-id="cv-experience-section">
            ...
            <div className="cv-cards-stack cv-experience-stack">
              {experiences.map((exp) => (
          ...
          <section className="cv-section cv-education-section" data-builder-component="EducationSection" data-builder-id="cv-education-section">
            ...
            <div className="cv-cards-stack cv-education-stack">
              {education.map((edu) => (
        ...
        <aside className="cv-sidebar" data-builder-id="cv-sidebar">
          ...
          <section className="cv-section cv-sidebar-section cv-languages-section" data-builder-id="cv-languages-section">
            <h2 className="cv-section-title cv-sidebar-title cv-language-title">Profile language</h2>
          ...
          <section className="cv-section cv-sidebar-section cv-skills-section" data-builder-id="cv-skills-section">
            <h2 className="cv-section-title cv-sidebar-title cv-skills-title">Top skills</h2>
          ...
          <section className="cv-section cv-sidebar-section cv-contact-section" data-builder-id="cv-contact-section">
            <h2 className="cv-section-title cv-sidebar-title cv-contact-title">Contact info</h2>
            <div className="cv-contact-list">
              <div className="cv-contact-item cv-contact-item-linkedin" data-builder-id="cv-contact-linkedin">
                <span className="cv-contact-icon cv-contact-icon-linkedin">
                  <svg className="cv-contact-glyph cv-contact-glyph-linkedin" width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path className="cv-contact-mark cv-contact-mark-linkedin" d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.79M6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69 1.69c0 .93.76 1.68 1.69 1.68m1.39 9.94v-8.37H5.5v8.37h2.77z"/></svg>
                </span>
                <span className="cv-contact-label cv-contact-label-linkedin">linkedin.com/in/joso</span>
              </div>
              <div className="cv-contact-item cv-contact-item-website" data-builder-id="cv-contact-website">
                <span className="cv-contact-icon cv-contact-icon-website">
                  <svg className="cv-contact-glyph cv-contact-glyph-website" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle className="cv-contact-mark cv-contact-mark-globe-ring" cx="12" cy="12" r="10"/><line className="cv-contact-mark cv-contact-mark-globe-equator" x1="2" y1="12" x2="22" y2="12"/><path className="cv-contact-mark cv-contact-mark-globe-meridian" d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
                </span>
                <span className="cv-contact-label cv-contact-label-website">joso.dev</span>
              </div>
              <div className="cv-contact-item cv-contact-item-github" data-builder-id="cv-contact-github">
                <span className="cv-contact-icon cv-contact-icon-github">
                  <svg className="cv-contact-glyph cv-contact-glyph-github" width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path className="cv-contact-mark cv-contact-mark-github" d="M12 2A10 10 0 0 0 2 12c0 4.42 2.87 8.17 6.84 9.5.5.08.66-.23.66-.5v-1.69c-2.77.6-3.36-1.34-3.36-1.34-.46-1.16-1.11-1.47-1.11-1.47-.91-.62.07-.6.07-.6 1 .07 1.53 1.03 1.53 1.03.87 1.52 2.34 1.07 2.91.83.09-.65.35-1.09.63-1.34-2.22-.25-4.55-1.11-4.55-4.92 0-1.11.38-2 1.03-2.71-.1-.25-.45-1.29.1-2.64 0 0 .84-.27 2.75 1.02.79-.22 1.65-.33 2.5-.33.85 0 1.71.11 2.5.33 1.91-1.29 2.75-1.02 2.75-1.02.55 1.35.2 2.39.1 2.64.65.71 1.03 1.6 1.03 2.71 0 3.82-2.34 4.66-4.57 4.91.36.31.69.92.69 1.85V21c0 .27.16.59.67.5C19.14 20.16 22 16.42 22 12A10 10 0 0 0 12 2z"/></svg>
                </span>
                <span className="cv-contact-label cv-contact-label-github">github.com/joso</span>
              </div>
            </div>
          </section>
        </aside>
