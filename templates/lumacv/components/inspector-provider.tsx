...
const SEMANTIC_CLASS_NAMES = new Set([
  ...
  "template-lumacv",
  "cv-profile-card",
  "cv-profile-name-main",
  "cv-profile-headline-main",
  "cv-profile-location-main",
  "cv-profile-action-open",
  "cv-profile-action-add",
  "cv-profile-action-more",
  "cv-profile-avatar-main",
  "cv-profile-avatar-main-fallback",
  "cv-about-section",
  "cv-about-title",
  ...
  "cv-experience-aws",
  "cv-experience-azure",
  "cv-experience-stripe",
  "cv-experience-aws-role",
  "cv-experience-azure-role",
  "cv-experience-stripe-role",
  "cv-experience-aws-description",
  "cv-experience-azure-description",
  "cv-experience-stripe-description",
  "cv-education-section",
  "cv-education-title",
  "cv-education-card",
  "cv-education-stanford",
  "cv-education-berkeley",
  "cv-education-stanford-degree",
  "cv-education-berkeley-degree",
  "cv-education-stanford-description",
  "cv-education-berkeley-description",
  "cv-skills-section",
  "cv-skill-typescript",
  "cv-skill-react",
  "cv-skill-python",
