...
help:
	...
	@printf "  $(C_GREEN)make apploop-reset$(C_RESET)        Remove .apploop projects, presentations, logs, databases, and template node_modules\n"
	...
	@printf "  $(C_GREEN)make apploop-seed-presentations$(C_RESET) Seed one demo presentation per presentation template\n"
	@printf "  $(C_GREEN)make apploop-seed$(C_RESET)          Migrate database, install template deps, and seed demo projects/presentations\n"
	@printf "  $(C_GREEN)make seed$(C_RESET)                  Full reset + apploop-seed (clean start with all demos)\n"
...
.PHONY: apploop-reset
apploop-reset:
	@printf "$(C_CYAN)->$(C_RESET) Removing .apploop state (projects, presentations, runtime-logs, databases)...\n"
	@rm -rf $(PROJECT_ROOT)/.apploop/projects $(PROJECT_ROOT)/.apploop/presentations $(PROJECT_ROOT)/.apploop/runtime-logs
	...
	@printf "$(C_GREEN)v$(C_RESET) .apploop and templates are now clean. Run $(C_BOLD)make apploop-seed$(C_RESET) to recreate the database and seed demos.\n"

.PHONY: apploop-db-migrate
apploop-db-migrate:
...
apploop-seed: apploop-seed-projects apploop-seed-presentations
	@printf "$(C_GREEN)v$(C_RESET) Database migrated and projects/presentations seeded. Run $(C_BOLD)make dev$(C_RESET) to start the builder.\n"
