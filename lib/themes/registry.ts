...
export const BUILT_IN_PROJECT_THEMES = [
  ...
  defineBuiltInTheme({
    id: "luma-cv-indigo",
    name: "Luma CV Indigo",
    description: "AI Engineer CV palette with deep blue-violet sidebar gradient, warm yellow-gold accent, and indigo actions.",
    preview: {
    ...
    light: {
      ...
      "--accent-foreground": "oklch(0.18 0.06 75)",
      "--chart-1": "oklch(0.52 0.28 275)",
      "--chart-2": "oklch(0.45 0.24 270)",
      "--chart-3": "oklch(0.38 0.2 265)",
      "--chart-4": "oklch(0.84 0.16 82)",
      "--chart-5": "oklch(0.68 0.14 78)",
      "--ring": "oklch(0.52 0.28 275)",
    },
    dark: {
      ...canonicalDark,
      "--background": "oklch(0.06 0.02 260)",
      "--sidebar": "oklch(0.09 0.03 258)",
      "--sidebar-foreground": "oklch(0.98 0 0)",
      "--sidebar-primary": "oklch(0.56 0.22 268)",
      "--sidebar-primary-foreground": "oklch(0.98 0.01 270)",
      "--sidebar-border": "oklch(1 0 0 / 8%)",
      "--primary": "oklch(0.52 0.26 278)",
      "--primary-foreground": "oklch(0.98 0.01 270)",
      "--accent": "oklch(0.82 0.18 78)",
      "--accent-foreground": "oklch(0.16 0.06 68)",
      "--chart-1": "oklch(0.52 0.28 275)",
      "--chart-2": "oklch(0.45 0.24 270)",
      "--chart-3": "oklch(0.38 0.2 265)",
      "--chart-4": "oklch(0.82 0.18 78)",
      "--chart-5": "oklch(0.66 0.14 75)",
      "--ring": "oklch(0.56 0.22 268)",
      "--radius": "0.75rem",
    },
  }),
